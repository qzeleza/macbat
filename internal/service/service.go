...
func Install() error {
	...
	// Создание plist
	if err := createPlistFile(binPath); err != nil {
...
func createPlistFile(binPath string) error {
...
</plist>`, paths.AgentIdentifier(), binPath, battery.GetCurrentCheckInterval(cfg), paths.LogPath(), paths.ErrorLogPath())
